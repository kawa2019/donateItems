...
export const Home = ({loggedUser}) => {
    ...
    return (
        <>
            <FirstView decor={<Decor text={decorTextMain} />} cta1={<CTA text={textBtn.text1} link loggedUser={loggedUser}/>} cta2={<CTA text={textBtn.text2} />} />
            <ThreeColumns />
            <Steps4 decor={<Decor text={decorTextSteps4} />} cta1={<CTA text={textBtn.text1} link loggedUser={loggedUser}/>} />
